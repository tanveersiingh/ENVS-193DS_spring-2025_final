...
nest_boxes_clean <- nest_boxes |>
  clean_names() |>
  select(box_occupant, season, edge_distance, sp, cs, e, tm) |>
...
\|:------------:\|:---:\|:---------------::-------: \|----------------------------- \|\
\| 0 \| \| \| null model \| \| 1 \| X \| X \| a saturated model. \| \| 2 \| X \| \| Season only model \| \| 3 \| \| X \| Distance to forest edge only model\|
...
ggplot(prediction,
  ...
  geom_jitter(data = nest_boxes_clean, aes(x = edge_distance, y = sp, color = season),
              width = 15, height = 0.5, alpha = 0.4, inherit.aes = FALSE) +
  ylim(0, 1) +
  labs(
  ...
  scale_color_manual(values = c("2016" = "lightgreen", "2019" = "seagreen")) +
  scale_fill_manual(values = c("2016" = "lightgreen", "2019" = "seagreen"))
